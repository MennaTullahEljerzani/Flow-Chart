...
void Output::CreateDesignToolBar()
{
	...
	pWind->DrawImage("images\\simulate.jpg", i++ * UI.MnItWdth, 0);
	...
	pWind->DrawImage("images\\load.jpg", i++ * UI.MnItWdth, 0);
	pWind->DrawImage("images\\Save.jpg", i++ * UI.MnItWdth, 0);
	pWind->DrawImage("images\\clear.jpg", i++ * UI.MnItWdth, 0);
	...
	pWind->DrawImage("images\\value.JPG", 0, i++ * UI.TlBrWdth);
	pWind->DrawImage("images\\var.jpg", 0, i++ * UI.TlBrWdth);
	pWind->DrawImage("images\\Oper.jpg", 0, i++ * UI.TlBrWdth);
	pWind->DrawImage("images\\Cond.jpg", 0, i++ * UI.TlBrWdth);
	pWind->DrawImage("images\\Read.jpg", 0, i++ * UI.TlBrWdth);
	pWind->DrawImage("images\\wrtie.jpg", 0, i++ * UI.TlBrWdth);
	pWind->DrawImage("images\\edit STAT.jpg", 0, i++ * UI.TlBrWdth);
...
void Output::CreateSimulationToolBar()
{
	...
	pWind->DrawImage("images\\step by step.jpg", i++ * UI.MnItWdth, 0);
...
void Output::ClearOutputBar()
{
	...
	pWind->DrawRectangle(UI.DrArWidth, UI.TlBrWdth, UI.width, UI.height - UI.StBrWdth);
}
//////////////////////////////////////////////////////////////////////////////////////////
...
// Writes a string in the specified location
